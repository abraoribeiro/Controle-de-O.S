...
import ControleCliente.ControleCadastroCliente;
...
public class CadastroCliente extends javax.swing.JDialog {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(tipo().equals("FISICA")){
            ...
            if(ControleCadastroCliente.cadastrarPF(pf)){
            ...
            pj.setCnpj(jTextField2.getText());
            pj.setEndereco(jTextField3.getText());
            pj.setRg(jTextField11.getText());
            pj.setFone1(jTextField4.getText());
            pj.setFone2(jTextField5.getText());
            pj.setCidade(jTextField6.getText());
            pj.setUf(uf());
            pj.setBairro(jTextField8.getText());
            pj.setCep(jTextField9.getText());
            pj.setComplemento(jTextField10.getText());
            pj.setEmail(jTextField7.getText());
            pj.setTipo(tipo());
            if(ControleCadastroCliente.cadastrarPJ(pj)){
                JOptionPane.showMessageDialog(null, "Dados cadastrados com sucesso");
            }
        }
